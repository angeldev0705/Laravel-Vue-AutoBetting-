...
<head>
  ...
  <meta property="og:image" content="{{ File::exists(public_path('images/og-image-udf.jpg')) ? asset('images/og-image-udf.jpg') : asset('images/og-image.jpg') }}" />
  <!--END Open Graph tags-->
...
<body class="theme-{{ config('settings.theme.mode') }} {{ $page_class }}">
  {{-- SPA container --}}
  <div id="app"></div>
